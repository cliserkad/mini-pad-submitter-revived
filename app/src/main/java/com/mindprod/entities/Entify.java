 ...
 * [Entify.java]
 *
 * Summary: converts awkward characters to HTML entities.
 *
 ...
 * <p/>
 * This utility is not as useful as it should be. It entifies < and > in tags and inside tags too. It is intended
 * only to process text files without any embedded tags yet. Fixing that is on my todo list.
 *
 ...
 * @since 2011-02-10
 */
public final class Entify extends EntifyStrings
    {
     ...
     */
    private static final String USAGE = "\nEntify needs a filename.html or a space-separated list of filenames, " +
    ...
    public static void main( String[] args )
        ...
        out.println( "Gathering html files to entify..." );
